function fish_prompt --description 'Write out the prompt'
    ...
    set_color -b black
    printf '%s%s%s%s%s%s%s%s%s%s%s%s%s%s' (set_color -o white) '(' (set_color yellow) $hostname '|' (set_color blue) $USER (set_color white) '|' (set_color yellow) (prompt_pwd) (set_color white) $git_info (set_color white) ')' (set_color white)
